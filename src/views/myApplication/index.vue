  ...
  await http
    ...
    .then((res: { code: number; result: any }) => {
      if (res.code == 200) {
        ...
        for (let i = 0; i < res.result.length; i++) groupSelect.value[i] = 0;
      }
    });
};
          ...
          >
            <template #title>
              <el-row style="width: 100%">
                <el-col
                  :span="3"
                  class="messageTitleCol"
                  style="justify-content: center"
                >
                  <img
                    :src="baseurl + message.clubAvatar"
                    class="messageAvatar"
                  />
                </el-col>
                <el-col :span="21">
                  <el-row style="height: 100%">
                    <el-col
                      :span="12"
                      class="messageTitleCol messageTitle"
            ...
            <div class="messageContentContainer">
              ...
              <el-row>
                ...
                <el-col :span="7">
                  <el-button
                    @click="confirmMessage(message.messageId)"
                    type="primary"
                    :disabled="message.isReceive != 0"
                  >
        ...
        >
          ...
          <el-table-column label="报名组别">
            <template #default="scope">
              <!--逆天eslint怎么不去死啊？？-->
              <el-select
                v-model="groupSelect[scope.$index]"
                class="messageSelect"
              >
                <el-option
          ...
          <el-table-column label="状态">
            <template #default="scope">
              ...
              <div
                v-if="
                  scope.row.groups[groupSelect[scope.$index]] &&
                  scope.row.groups[groupSelect[scope.$index]].status == 0
                "
                style="color: #dc5c5c"
              >
                未面试
              ...
              <div
                v-if="
                  scope.row.groups[groupSelect[scope.$index]] &&
                  scope.row.groups[groupSelect[scope.$index]].status == 1
                "
                class="color: #ffbf00"
              >
                已面试
              ...
              <div
                v-if="
                  scope.row.groups[groupSelect[scope.$index]] &&
                  scope.row.groups[groupSelect[scope.$index]].status == 2
                "
                class="color: #93EA86;"
              >
                一面过
