...
const model = defineModel<describeQ>({default:{type:'s',title:'',required:false,groups:[]}})
...
<template>
    <el-form-item>
        ...
        <el-row style="display:flex;align-items: flex-start;">
            <div class="questionTitle">文本描述&emsp;</div>
            <el-row>
                <el-input placeholder="请输入文本描述" class="textInput" v-model="model.title"></el-input>
                <el-checkbox style="visibility: hidden;" v-model="model.required" label="必填" />
